...
test_that("clusters split", {
  ...
  expect_equal(cl2$first_param, c(10,40,50,190,200,220))
  expect_equal(cl2$opt_param, c(10,40,50,190,200,220))
  expect_equal(cl2$last_param, c(10,40,50,190,200,220))
